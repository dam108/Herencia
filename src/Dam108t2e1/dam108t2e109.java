...
public class dam108t2e109 {
    ...
    public static void main(String[] args) {
        ...
        do {
           System.out.println("\n\n---- Gestion de Cuenta Plazo -----");
            System.out.println("a)Ingresar \nb)Retirar\nc)Consultar Saldo\nd)Salir");
           opcion = teclado.next().charAt(0); 
           switch (opcion) {
               case 'a': Ingresar (cuentaActiva);  break;
               case 'b': Retirar (cuentaActiva);  break;
               case 'c': Consultar (cuentaActiva);  break;
               case 'd': salir = true; break;
               default: System.out.println("Opción invalida"); 
           }
        } while (!salir);
    }
    static void Ingresar (CuentaPlazo cuenta) {
        float importe;
        float saldo;
    ...
    static void Retirar (CuentaPlazo cuenta) {
        float importe;
        boolean retiro;
        float saldo;
    ...
    static void Consultar (CuentaPlazo cuenta) {
